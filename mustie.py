...
DEFAULT_CREW_THRESHOLDS: dict[str, dict] = {
    "A": {"label": "General Works",              "max_age": 10, "max_no_circ_years": 3},
    "B": {"label": "Philosophy & Psychology",     "max_age": 10, "max_no_circ_years": 3},
    "C": {"label": "Auxiliary Sciences of History","max_age": 15, "max_no_circ_years": 5},
    "D": {"label": "World History",               "max_age": 15, "max_no_circ_years": 5},
    "E": {"label": "American History",            "max_age": 15, "max_no_circ_years": 5},
    "F": {"label": "Local American History",      "max_age": 15, "max_no_circ_years": 5},
    "G": {"label": "Geography & Recreation",      "max_age": 10, "max_no_circ_years": 3},
    "H": {"label": "Social Sciences",            "max_age": 10, "max_no_circ_years": 3},
    "J": {"label": "Political Science",           "max_age": 10, "max_no_circ_years": 3},
    "K": {"label": "Law",                         "max_age": 5,  "max_no_circ_years": 2},
    "L": {"label": "Education",                   "max_age": 10, "max_no_circ_years": 3},
    "M": {"label": "Music",                       "max_age": 15, "max_no_circ_years": 5},
    "N": {"label": "Fine Arts",                   "max_age": 15, "max_no_circ_years": 5},
    "P": {"label": "Language & Literature",        "max_age": 20, "max_no_circ_years": 3},
    "Q": {"label": "Science",                     "max_age": 5,  "max_no_circ_years": 2},
    "R": {"label": "Medicine",                    "max_age": 5,  "max_no_circ_years": 2},
    "S": {"label": "Agriculture",                 "max_age": 10, "max_no_circ_years": 3},
    "T": {"label": "Technology",                  "max_age": 5,  "max_no_circ_years": 2},
    "U": {"label": "Military Science",            "max_age": 15, "max_no_circ_years": 5},
    "V": {"label": "Naval Science",               "max_age": 15, "max_no_circ_years": 5},
    "Z": {"label": "Bibliography & Library Science","max_age": 5, "max_no_circ_years": 2},
}
